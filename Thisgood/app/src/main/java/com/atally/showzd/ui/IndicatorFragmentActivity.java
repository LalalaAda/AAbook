...
public abstract class IndicatorFragmentActivity extends FragmentActivity implements ViewPager.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView wdzb_txt= (TextView) this.findViewById(R.id.wdzb_txt);
        ImageView wdzb_img= (ImageView) this.findViewById(R.id.wdzb_img);
        SharedPreferences sp=getSharedPreferences("MainActivity",MODE_PRIVATE);
        String qw=sp.getString("user", "默认账本");
        wdzb_txt.setText(qw);
        initViews();
