...
import com.atally.models.Mypackage;
import com.atally.models.P_consume;
import com.atally.models.P_income;
import com.atally.myview.Budget;
import com.atally.myview.LoginOut;
import com.atally.myview.MyProcessBar;
import com.atally.myview.Xiaofei;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ZhangbenName=sp.getString("user","默认账本");
...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_zhangben) {
            Intent intent2=new Intent(MainActivity.this,Zhangben.class);
            intent.putExtra("zbzb", ZhangbenName);
            //// TODO: 4/15/2016  做多账本 
            MainActivity.this.finish();
